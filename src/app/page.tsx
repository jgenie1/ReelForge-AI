            ...
            {onboardingStep === 2 && (
              <div className="flex flex-col gap-6">
                <div>
                  ...
                  <p className="text-xs text-gray-400">{language === "fr" ? "Définissez le style visuel généré automatiquement par Imagen 3." : "Define the visual style automatically generated by Imagen 3."}</p>
                </div>
