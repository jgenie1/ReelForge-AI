...
export async function GET(req: Request) {
  try {
    ...
    const mockVideos = [
      { id: 'vid-1', title: 'Le secret terrifiant du Sahara', niche: 'Science Insolite', style: 'Cinématique SDXL', duration: 30, status: 'COMPLETED', videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4', viralScore: 84, views: 1200000, likes: 84000, createdAt: new Date(Date.now() - 2 * 3600000) },
      ...
      { id: 'vid-3', title: "L'Ombre d'Anubis - Épisode 1", niche: 'Mythologie', style: 'Dark Fantasy', duration: 30, status: 'COMPLETED', videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4', viralScore: 92, views: 340000, likes: 21000, createdAt: new Date(Date.now() - 24 * 3600000) },
      ...
      { id: 'vid-5', title: "5 Lois Secrètes de l'Argent", niche: 'Finance & Richesse', style: 'Cinématique SDXL', duration: 30, status: 'COMPLETED', videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4', viralScore: 88, views: 3400000, likes: 210000, createdAt: new Date(Date.now() - 72 * 3600000) },
      { id: 'vid-6', title: "Les Créatures du Marais Haïtien", niche: 'Culture Haïtienne', style: 'Dark Fantasy', duration: 45, status: 'COMPLETED', videoUrl: 'https://www.w3schools.com/html/mov_bbb.mp4', viralScore: 79, views: 156000, likes: 12000, createdAt: new Date(Date.now() - 4 * 24 * 3600000) },
    ];
